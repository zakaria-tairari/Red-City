          ...
          >
            <div className="overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-stone-900/8">
              ...
              <div className="flex items-center gap-3 border-t border-stone-100 px-4 py-2.5">
                <kbd className="inline-flex items-center rounded bg-stone-100 px-1.5 py-0.5 text-[11px] text-stone-500">
                  ↑↓
                </kbd>
                <span className="text-xs text-stone-400">{ t("common.navigate") }</span>
                <kbd className="inline-flex items-center rounded bg-stone-100 px-1.5 py-0.5 text-[11px] text-stone-500">
                  ↵
                </kbd>
                <span className="text-xs text-stone-400">{ t("search.label") }</span>
                <kbd className="ml-auto inline-flex items-center rounded bg-stone-100 px-1.5 py-0.5 text-[11px] text-stone-500">
                  esc
                </kbd>
